    ...
    >
      <div className="flex justify-start xs:block sm:block md:mb-[10px] md:flex">
        <div className="w-110 5xl:ml-40px transition-all md:mr-[80px]">
          ...
          <h3
            className="mb-20 mt-12 block cursor-pointer justify-center font-tahoma 
          text-2xl font-bold text-white transition-all xs:mb-[20px] xs:flex 
          xs:font-medium md:block md:text-base xl:mb-[18px] xl:flex xl:w-[300px] xl:text-xl 2xl:w-[250px]"
          >
            За крок до офферу
          </h3>
        </div>
      ...
      <div className="flex items-center justify-center px-10 py-8 xs:flex-col xs:px-0 sm:flex-col sm:px-0 md:flex md:w-[700px] md:flex-row md:items-center md:justify-center md:px-0 md:pt-[15px] xl:mx-auto">
        <p className="text-base text-white xs:text-[12px] sm:text-xs md:mr-[4px] md:text-sm">
          Компанія направляє 10% прибутку на підтримку
        </p>
        <p className="text-white xs:text-[12px] sm:text-xs md:mr-[4px] md:text-sm">
          59-тої бригади
        </p>
        <p className="text-white xs:text-[12px] sm:text-xs md:text-sm">
          ім.Якова Гандзюка
        </p>
      </div>
