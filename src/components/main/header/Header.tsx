...
const Header = () => {
  ...
  return (
    <header className="border-b  border-[#4E4E4E] bg-graphite px-20">
          ...
          <ul className="flex hover:text-rose">
            {occupations.map((occupation, index) => (
              <li
                ...
                className="group flex cursor-pointer flex-row p-4 text-base text-white hover:text-rose">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  id="icon"
                  className="relative top-1 mr-2 h-4 w-4 text-white transition-colors duration-300 group-hover:text-rose">
                  <path
                    fill="currentColor"
                ...
                {!checkedStates[index] ? (
                  <svg
                    className="relative top-2 ml-4 h-4 w-4 text-white transition-colors duration-300 group-hover:text-rose"
                    xmlns="http://www.w3.org/2000/svg"
