  ...
  return (
    ...
    >
      <div className=" mx-auto flex justify-start xs:block sm:block md:mb-[10px] md:flex">
        ...
        <div className="ml-[292px] mr-[90px] flex-col text-white xs:mx-0 xs:flex sm:mx-0 md:ml-0 md:mr-[50px] md:w-[300px] md:items-start xl:ml-[180px] xl:mr-[100px] 2xl:ml-[230px] 2xl:mr-[290px] 4xl:ml-[300px] 4xl:mr-[350px] 5xl:ml-[485px] 5xl:mr-[340px] ">
          <button
      ...
      <div className="flex xs:flex-col-reverse xs:py-[20px] sm:flex-col-reverse md:mr-[6px] md:flex-col-reverse md:leading-3 xl:flex xl:flex-row">
        ...
        <div className="flex-1 xs:mb-[25px] md:mb-[10px] md:flex md:justify-between xl:mb-0">
          {isCookiesAccepted
            ? (
                <Link
            ...
            : (
                <span className="gray-700 inline-block justify-center font-sans text-sm text-white transition-all  xs:flex sm:flex sm:text-lg md:mb-[4px] md:text-nowrap md:leading-8 md:decoration-0">
                  {t('privacy_policy')}
                </span>
              )}
          {isCookiesAccepted
            ? (
                <Link
                  className="hover:decoration gray-700 inline-block cursor-pointer justify-center font-sans text-sm text-white transition-all hover:text-yellow xs:flex sm:flex sm:text-lg md:mb-[4px] md:mr-[45px] md:text-nowrap md:leading-8 md:decoration-0"
            ...
            : (
                <span className="gray-700 mr-[40px] inline-block justify-center font-sans text-sm text-white transition-all  xs:flex sm:flex sm:text-lg md:mb-[4px] md:text-nowrap md:leading-8 md:decoration-0">
                  {t('terms_of_use')}
                </span>
              )}
        </div>
