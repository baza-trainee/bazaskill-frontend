          ...
          {partners.map((partner) => (
            <figure key={partner.id} className="partner-item mx-4">
              <Image
                ...
                alt={partner.name}
                className='w-full min-w-[90vw] sm:min-w-[350px] aspect-video object-contain border-[1rem] rounded-md border-zinc-300 grayscale hover:filter-none hover:scale-110 transition ease-in-out duration-700 p-2 bg-white'
              />
