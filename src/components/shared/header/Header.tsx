...
export default function Header(): React.JSX.Element {
  return (
    <header className="max-w-screen fixed top-0 z-50 w-full bg-black">
      <AffiliateBanner />
        ...
        <div className="mx-auto flex max-w-[1280px] items-center justify-between py-[11px] sm:py-[16px] md:py-[25px]">
          <div className="flex items-center sm:ml-[calc(100%/2-65px)] md:ml-0 xl:h-[40px]">
            <Link
              ...
              scroll={true}
            >
              <Logo className="ml-[-20px] scale-75 transition duration-500 sm:scale-100 md:ml-0 md:scale-100 md:hover:scale-110" />
            </Link>
          </div>
          <NavHeader />
